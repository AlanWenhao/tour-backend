...
const users =
    `create table if not exists users(
     ...
     is_admin VARCHAR(128) NOT NULL COMMENT '管理员',
     avator VARCHAR(128) NOT NULL COMMENT '头像',
...
const articles = 
    ...
    md TEXT NOT NULL COMMENT '评论内容',
    uid VARCHAR(64) NOT NULL COMMENT '作者id',
    ...
    moment VARCHAR(128) NOT NULL COMMENT '创建时间',
    PRIMARY KEY(id)
    )`
